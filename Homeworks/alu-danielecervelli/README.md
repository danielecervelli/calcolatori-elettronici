...
:heavy_plus_sign: Somma corretta |
| :----------------------------------------------------------- |
...
:arrow_left: shift a sinistra di una posizione di $a$ corretto |
| :----------------------------------------------------------- |
...
:heavy_check_mark::heavy_check_mark: Ca​lcolo corretto dell'AND logico |
| :----------------------------------------------------------- |
...
:white_circle: :black_circle: Calcolo corretto dell'OR logico |
| :----------------------------------------------------------- |
...
:white_circle: :black_circle: :white_circle: Calcolo corretto dello XOR logico |
| :----------------------------------------------------------- |
...
:white_check_mark: :heavy_plus_sign: :white_check_mark: / :heavy_multiplication_x: :heavy_plus_sign: :heavy_multiplication_x:  Calcolo corretto dell'XNOR logico |
| :----------------------------------------------------------- |
...
:heavy_check_mark: :heavy_multiplication_x:  Calcolo corretto del NAND logico |
| :----------------------------------------------------------- |
...
:no_entry_sign: :white_circle: :white_circle:  Calcolo corretto del NOR logico |
| :----------------------------------------------------------- |
...
:white_check_mark: :arrow_right: :heavy_multiplication_x: Calcolo corretto della negazione di $a$ |
| :----------------------------------------------------------- |
...
*Attenzione*: verranno considerate soltanto le soluzioni caricate nel branch `master`. Potete utilizzare altri branch se volete, ma per la consegna finale varrà soltanto quanto contenuto in `master`.
